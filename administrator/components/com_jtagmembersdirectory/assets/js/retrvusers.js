...
{
  var url = 'index.php?option=com_jtagmembersdirectory&task=retrieveUsers&format=raw';
  ...
  if (MooTools.version < '1.3')
  {
    var retvusers = new Ajax(url, {
        ...
        onRequest: function(data) {
          $('userlist_results').innerHTML = '<div class="loader"><img src="components/com_jtagmembersdirectory/assets/images/loader.gif" width="128" height="128" /></div>';
        },
...
function jtagMDSetUser(data)
{
  ...
  {
    window.location = 'index.php?option=com_jtagmembersdirectory&controller=jtagmembersdirectory&task=member&mid='+data.md_profile;
  }
