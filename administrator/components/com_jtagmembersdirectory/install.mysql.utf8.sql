CREATE TABLE IF NOT EXISTS `#__jtmb_members_directory` (
...
CREATE  TABLE IF NOT EXISTS `#__jtmb_custom_maps_members` (
  `user_id` int(11) NOT NULL,
 `field_label` varchar(50) NOT NULL,
  `field_value` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS `#__jtmb_member_request` (
  `user_id` int(10) NOT NULL,
