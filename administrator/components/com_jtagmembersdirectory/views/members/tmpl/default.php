...
function clearAll()
{
  ...
  <table class="adminlist" style="margin-top:20px;">
    <thead>
        ...
        <th>
					<?php echo JHtml::_('grid.sort', JTAG_MEMBERS_LIST_PHONE_NO, 'phone_no', $this->lists['order_Dir'], $this->lists['order']); ?>
				</th>

<!-- Start - Snehal Kulkarni - 05/09/2012- To display Email information on the form -->
<th>
					<?php echo JHtml::_('grid.sort',JTAG_MEMBERS_LIST_EMAIL, 'Email', $this->lists['order_Dir'], $this->lists['order']); ?>
				</th>
<!-- End - Snehal Kulkarni - 05/09/2012- To display Email information on the form -->
     <!--   <th>
					<?php echo JHtml::_('grid.sort', JTAG_MEMBERS_LIST_MEMBER_SINCE, 'member_since', $this->lists['order_Dir'], $this->lists['order']); ?>
				</th>-->
		<th>
					<?php echo JHtml::_('grid.sort',JTAG_MEMBERS_LIST_CATEGORY, 'cat_id', $this->lists['order_Dir'], $this->lists['order']); ?>
				</th>
<th>
