...
<form action="index.php" method="post" name="adminForm" id="adminForm">
  ...
  <table class="adminlist">
	...
	?>
        <tr>
            <td class="catCenter">
	<a href="index.php?option=com_jtagobjectsdirectory&controller=jtagobjectsdirectory&task=category&cid=<?php echo $row->id ?>&name=<?php echo $row->name ?>&description=<?php echo $row->description ?>"><?php echo $row->id ?></a>
			</td>
            <td class="catCenter">
             <?php
