...
class JtagobjectDirectoryViewCategories extends JViewLegacy
{
	...
	{  
		...
		$categoryModel= new JtagobjectDirectoryModelCategory();
        ...
        JToolBarHelper::title(JText::_('JTAG_BACKEND_CATEGORY_TITLE'), 'jtagobject.jpg');
