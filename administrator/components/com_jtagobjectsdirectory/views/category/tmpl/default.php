...
<script type="text/javascript">
	...
	function submitbutton(pressbutton) {
		...
		if (trim( document.adminForm.name.value ) == "") {
			alert( '<?php echo JText::_(JTAG_object_CATEGORY_FORM_NO_NAME_ERROR, true);?>' );
		} else {
			submitform( pressbutton );
		}
	}
...
<form action="index.php" method="post" name="adminForm" id="adminForm">
  <fieldset class="adminform">
    <legend><?php echo JText::_('JTAG_object_CATEGORY_FORM'); ?></legend>
    <table class="admintable">
     <tbody>
         <tr>
            <td class="key"><?php echo JText::_(JTAG_object_CATEGORY_FORM_NAME); ?></td>
            <td>
	  ...
	  <tr>
            <td class="key"><?php echo JText::_(JTAG_object_CATEGORY_FORM_DESCRIPTION); ?></td>
            <td>
	...
	<tr>
	    <td class="key"><?php echo JText::_(JTAG_object_CATEGORY_FORM_PUBLISHED); ?></td>
	    <td>
