...
$controllerClass = 'JtagobjectDirectoryController'.ucfirst($controllerName);
...
{
     JSubMenuHelper::addEntry(JText::_('JTAG_BACKEND_MENU_DASHBOARD'), 'index.php?option=com_jtagobjectsdirectory&c=dashbord',$menuItem=='Dashbord');
     JSubMenuHelper::addEntry(JText::_('JTAG_BACKEND_MENU_objectS'), 'index.php?option=com_jtagobjectsdirectory&c=objects',$menuItem=='objects');
     JSubMenuHelper::addEntry(JText::_('JTAG_BACKEND_MENU_CATEGORIES'), 'index.php?option=com_jtagobjectsdirectory&c=categories',$menuItem=='Categories');
     
/*Priyanka Bhorkade 08-01-2013 To add the today's registered users to jtag objects. */
JSubMenuHelper::addEntry('Users', 'index.php?option=com_jtagobjectsdirectory&c=Users',$menuItem=='Users');
/* end */

     JSubMenuHelper::addEntry(JText::_('JTAG_BACKEND_MENU_FILTERS'), 'index.php?option=com_jtagobjectsdirectory&c=filters',$menuItem=='filters');
      ...
      {
      		JSubMenuHelper::addEntry(JText::_('Requests'), 'index.php?option=com_jtagobjectsdirectory&c=adduser',$menuItem=='Adduser');
      }
}
?>
