...
class jtagmemberdirectoryViewmembers extends JViewLegacy
{
  ...
  function _addToolbar()
  {
    ...
    JToolBarHelper::title(JText::_('JTAG_BACKEND_MEMBERS_LIST_TITLE'));
    JToolBarHelper::addNew('member');
    JToolBarHelper::deleteList(JTAG_CONFIRM_DELETE_MESSAGE, 'deleteMembers');
/* Start - Snehal Kulkarni- Import all users -date-06/09/2012*/
     JToolBarHelper::addNew('addAll',JText::_(JTAG_IMPORT_ALL_MEMBERS));
