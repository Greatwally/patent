 ...
 * @subpackage Jtagmemberdirectory
 */
class JtagMemberDirectoryControllerUsers extends JControllerLegacy {
        ...
        switch($this->getTask())
		 {
             ...
             case 'cancel' :
				{
					JRequest::checkToken() or jexit('Invalid Token');
					$this->setRedirect( 'index.php?option=com_jtagmembersdirectory&c=Users' );;
                }
					break;
      ...
      /*     	case 'save'     :
			...
			*/
                        ...
                        default:
			{
				...
				$view = $this->getView('users', 'html', 'jtagmemberdirectoryView');
