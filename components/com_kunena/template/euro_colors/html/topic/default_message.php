...
<div class="kmsgbody">
	<div class="kunena-message-top">
		<?php $this->displayModulePosition('kunena_msg_top_' . $this->mmm) ?>
	</div>
	<div class="kmsgtext">
		<?php echo KunenaHtmlParser::parseBBCode ($this->message->message, $this) ?>
	</div>
	<div class="kunena-message">
		<?php $this->displayModulePosition('kunena_msg_bottom_' . $this->mmm) ?>
	</div>
</div>
<div>
