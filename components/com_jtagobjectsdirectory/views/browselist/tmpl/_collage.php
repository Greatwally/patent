...
<div class="polaroid-images">
 <?php foreach ($users as $user): ?>
   <a  href="<?php echo JRoute::_('index.php?option=com_jtagobjectsdirectory&format=html&task=objectDetails&mid='.$user->id) ?>" title="" >
		<img  src="components/com_jtagobjectsdirectory/assets/profile_pictures/thumb/<?php echo $user->profile_picture ? $user->profile_picture : 'profile2.jpg' ?>" alt="<?php echo $user->name ?>'s photo" height="100"  title="<?php echo $user->name ?>" /> <p class="caption"><b> <?php echo $user->name ?></b></p></a>
