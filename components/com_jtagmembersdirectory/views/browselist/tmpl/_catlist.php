...
<input type="submit" name="submit" value="Add in members directory">
<?php } ?>
</span>
<?php $cat=0; $custm=0;?>
...
<?php endforeach; ?>
<?php endif; ?>
<?php $params = & JTagHelper::getComponentParameters('com_jtagmembersdirectory');
...
<?php if($cat==0 And $catwise==0): ?>
       ...
       <?php if (count($categories) > 0): ?>
			<?php foreach ($categories as $cat):$link = JRoute::_('index.php?option=com_jtagmembersdirectory&amp;Itemid='.JRequest::getVar('Itemid').'&amp;cat_id='.$cat->id) ?>
