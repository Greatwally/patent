...
<div id="k2Container" class="itemListView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>" itemscope itemtype="https://schema.org/Blog">
				...
				if ($rowcount == 1) : ?>
					...
					<?php endif; ?>
						<div class="span<?php echo round(12 / $this->params->get('num_leading_columns'));?>">
							<div class="itemContainer<?php echo $lastContainer; ?>" itemprop="blogPost" itemscope itemtype="https://schema.org/BlogPosting">
								<?php
