...
{
   $filter_order     = $mainframe->getUserStateFromRequest(  $option.'objects_directory_list.filter_order', 'filter_order', 'user_id', 'cmd' );
}
	  $filter_order_Dir = $mainframe->getUserStateFromRequest( $option.'objects_directory_list.filter_order_Dir', 'filter_order_Dir', 'asc', 'word' );
...
public function publish($cid = array(), $publish = 1)
	{
		...
		if (count( $cid ))
		{
			...
			$query = 'UPDATE `#__jtmb_objects_directory`'
