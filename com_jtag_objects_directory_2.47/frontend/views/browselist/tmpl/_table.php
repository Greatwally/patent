  ...
  <th>Name </th>
       <?php if($user_id==0):?>
              <?php if($options->display_nr_email==1 || !$options):?>
                <th><img src="components/com_jtagobjectsdirectory/assets/images/mail.gif"/> Email </th>
              <?php endif;?>
        <?php else:?>
               <th><img src="components/com_jtagobjectsdirectory/assets/images/mail.gif"/> Email </th>
        <?php endif;?>
        <?php if($user_id==0):?>
            <?php if($options->display_nr_phone_no==1|| !$options):?>
              <th><img src="components/com_jtagobjectsdirectory/assets/images/phone.gif"/> Phone </th>
            <?php endif;?>
        <?php else:?>
